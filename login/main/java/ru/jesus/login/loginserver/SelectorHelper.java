...
import ru.jesus.login.loginserver.network.serverpackets.Init;
import ru.jesus.login.loginserver.mmocore.HeaderInfo;
import ru.jesus.login.loginserver.mmocore.IAcceptFilter;
import ru.jesus.login.loginserver.mmocore.IClientFactory;
import ru.jesus.login.loginserver.mmocore.IMMOExecutor;
...
import ru.jesus.login.loginserver.mmocore.TCPHeaderHandler;
...
public class SelectorHelper extends TCPHeaderHandler<L2LoginClient> implements IMMOExecutor<L2LoginClient>, IClientFactory<L2LoginClient>, IAcceptFilter
{
	...
	/**
	* @see TCPHeaderHandler#handleHeader(java.nio.channels.SelectionKey, java.nio.ByteBuffer)
	*/
	@Override
