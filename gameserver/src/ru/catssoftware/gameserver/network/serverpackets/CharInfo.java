	...
	{
		{
				...
				if(template != null)
				{
					...
					else
					{
						...
						if(_activeChar.isInFunEvent())
							writeS(_activeChar._event.getTitle(_activeChar, activeChar));
						else
							writeS(_activeChar.getTitle());
					}
					
					if(_activeChar.isInFunEvent())
						writeS(_activeChar._event.getName(_activeChar, activeChar));
					else
			...
			else
			{
				...
				if(_activeChar.isInFunEvent())
					writeD(_activeChar._event.getCharNameColor(_activeChar, activeChar));
				else	
				...
				writeD(0x00); // ??
				if(_activeChar.isInFunEvent())
					writeD(_activeChar._event.getCharTitleColor(_activeChar, activeChar));
				else	
