...
import ru.catssoftware.gameserver.model.entity.ClanHall.ClanHallFunction;

public class AgitDecoInfo extends L2GameServerPacket
{
	private static final String	_S__F7_AGITDECOINFO	= "[S] f7 AgitDecoInfo [dcccccccccccdd]";
