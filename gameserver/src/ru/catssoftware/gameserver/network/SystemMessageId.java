...
public enum SystemMessageId
{
	...
	/**
	 * ID: 139<br>
	 * Message: Умение $s2 не подействовало на цель $c1.
	 */
	C1_WAS_UNAFFECTED_BY_S2(139),
	...
	/**
	 * ID: 157<br>
	 * Message: Поглощение персонажа $c1 не оказало на Вас воздействия.
	 */
	...
	/**
	 * ID: 159<br>
	 * Message: Магия персонажа $c1 не оказала на Вас воздействия.
	 */
	...
	/**
	 * ID: 316<BR>
	 * Console Message: You have failed to withdraw from the party.
	 */
	COULD_NOT_LEAVE_PARTY(316),	
	/**
	 * ID: 317<BR>
	 * Console Message: You have failed to expel the party member.
	 */
	COULD_NOT_OUST_FROM_PARTY(317),
	// 318 empty
	...
	/**
	 * ID: 927<br>
	 * Message: The current time is $s1:$s2 AM.
	 */
	CURRENT_TIME_S1_S2_AM(927),

	/**
	 * ID: 928<br>
	 * Message: The current time is $s1:$s2 PM.
	 */
	CURRENT_TIME_S1_S2_PM(928),
	...
	/**
	 * ID: 1500<br>
	 * Message: A sub-class character cannot participate in the Olympiad.
	 */
	...
	/**
	 * ID: 1591<br>
	 * Message: No use has been invited to the Command Channel.
	 */
