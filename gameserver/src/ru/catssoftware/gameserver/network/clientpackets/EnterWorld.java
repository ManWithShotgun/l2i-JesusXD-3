...
import ru.catssoftware.gameserver.network.serverpackets.Die;
import ru.catssoftware.gameserver.network.serverpackets.ExBasicActionList;
...
import ru.catssoftware.gameserver.network.serverpackets.PledgeStatusChanged;
...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(activeChar._event!=null && activeChar._event.getState()==GameEvent.STATE_ACTIVE)
			activeChar.addMessage("<html><body><br>Не забудьте, вы участник эвента <font color=\"LEVEL\">"+activeChar._event.getName()+"</font>!</body></html>");
