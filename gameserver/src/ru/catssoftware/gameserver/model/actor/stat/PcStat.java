...
public class PcStat extends PlayableStat
{
	...
	public boolean addExpAndSp(long addToExp, int addToSp)
	{
		...
		baseRates[0] = ((float)addToExp)/(float)(activeChar.getPremiumService()>0?Config.PREMIUM_RATE_XP:Config.RATE_XP);
		baseRates[1] = ((float)addToSp)/(float)(activeChar.getPremiumService()>0?Config.PREMIUM_RATE_SP:Config.RATE_SP);
