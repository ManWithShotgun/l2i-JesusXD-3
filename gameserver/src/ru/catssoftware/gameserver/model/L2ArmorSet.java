...
public final class L2ArmorSet
{
	...
	//L2EMU_ADD - Charus Support for set Ids
	private final int	_skillsetId;
	//L2EMU_ADD
	...
	//L2EMU_EDIT- Charus Support for set Ids
	public L2ArmorSet(int chest, int legs, int head, int gloves, int feet, int skillId, int skillLvl, int skillsetId, int shield, int shieldSkillId, int enchant6Skill)
	//L2EMU_EDIT
	{
		_chest = chest;
		_legs = legs;
	...
	public boolean isEnchanted6(L2PcInstance player)
	{
		...
		//L2EMU_EDIT Visor123
		if (chestItem == null || glovesItem == null || headItem == null || feetItem == null)
			return false;
