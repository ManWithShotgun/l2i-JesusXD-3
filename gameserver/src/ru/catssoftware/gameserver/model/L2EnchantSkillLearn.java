...
public final class L2EnchantSkillLearn
{
	...
	public L2EnchantSkillLearn(int id, int lvl, int minSkillLvl, int baseLvl, String name, int cost, int exp, byte rate76, byte rate77, byte rate78, byte rate79, byte rate80)
	{
		_id = id;
		_level = lvl;
		_baseLvl = baseLvl;
