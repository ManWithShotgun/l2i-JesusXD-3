...
{
	public FuncSub(Stats pStat, int pOrder, FuncOwner pFuncOwner, String value, Condition pCondition)
	{
		super(pStat, pOrder, pFuncOwner, value, pCondition);
	}
	public FuncSub(Stats pStat, int pOrder, FuncOwner pFuncOwner, double value, Condition pCondition)
	{
