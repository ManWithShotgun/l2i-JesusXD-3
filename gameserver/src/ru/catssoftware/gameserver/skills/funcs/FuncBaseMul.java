...
{
	public FuncBaseMul(Stats pStat, int pOrder, FuncOwner pFuncOwner, String value, Condition pCondition)
	{
		super(pStat, pOrder, pFuncOwner, value, pCondition);
	}
	public FuncBaseMul(Stats pStat, int pOrder, FuncOwner pFuncOwner, double value, Condition pCondition)
	{
